...
function initApp() {
    ...
    const i18n = {
        "tr": {
                ...
                "guide_step1_title": "Gemini Yapay Zeka API Anahtarı Kurulumu",
                ...
                "guide_step2_title": "Kartela Tarama ve Otomatik Okuma",
                ...
                "guide_step3_title": "Görsel Etiket Tasarımı & Barkod Baskısı",
                ...
                "guide_step4_title": "Excel İçe/Dışa Aktarma ve Bulut Yedekleme",
        ...
        "en": {
                ...
                "guide_step1_title": "Google Gemini AI API Key Setup",
                "guide_step1_desc": "FabricTag uses Google Gemini AI to analyze swatch cards. Simply get your free API key from Google AI Studio and paste it in the Settings tab.",
                "guide_step1_btn": "Get Free Google API Key",
                "guide_step2_title": "Swatch Card Scanning & Auto OCR",
                "guide_step2_desc": "Upload swatch photos via Webcam continuous mode, Mobile Wireless QR scanner, or File Upload. AI extracts all fabric specs in seconds.",
                "guide_step3_title": "Visual Label Designer & Barcode Printing",
                "guide_step3_desc": "Upload your company logo, drag-and-drop label rows, customize fonts, colors, and live preview. Fully compatible with A4 sheets and thermal roll printers.",
                "guide_step4_title": "Excel Import/Export & Cloud Backups",
                "guide_step4_desc": "Easily import your existing Excel catalog or export filtered records. Automatic OneDrive cloud backup protects your data every day.",
                "btn_understood": "Understood, Let's Start",
        ...
        "de": {
                ...
                "guide_modal_title": "FabricTag Schnellstartanleitung"
        },
        "it": {
                "lang_label": "Lingua:",
                ...
                "guide_modal_title": "Guida Rapida FabricTag"
        },
        "es": {
                "lang_label": "Idioma:",
                ...
                "guide_modal_title": "Guía de Inicio Rápido de FabricTag"
        },
        "fr": {
                "lang_label": "Langue:",
        ...
        "ar": {
                ...
                "guide_modal_title": "دليل البدء السريع لـ FabricTag",
                "guide_step1_title": "إعداد مفتاح Gemini AI الذكي",
                "guide_step1_desc": "يستخدم FabricTag نموذج Google Gemini لقراءة البطاقات. احصل على مفتاح مجاني من Google AI Studio وضعه في الإعدادات.",
                "guide_step1_btn": "الحصول على مفتاح Google مجاني",
                "guide_step2_title": "مسح البطاقات والتعرف التلقائي",
                "guide_step2_desc": "يمكنك التقاط الصور عبر كاميرا الكمبيوتر، أو مسح QR عبر الهاتف لاسلكياً، أو رفع الصور مباشرة.",
                "guide_step3_title": "تصميم الملصق وطباعة الباركود",
                "guide_step3_desc": "قم برفع شعار شركتك ورتب أسطر الملصق بالسحب والإفلات. متوافق مع ورق A4 وطابعات الرول الحرارية.",
                "guide_step4_title": "تصدير واستيراد إكسل والنسخ السحابي",
                "guide_step4_desc": "استورد أرشيفك من إكسل بنقرة واحدة أو صدر البيانات. النسخ السحابي مع OneDrive يحمي بياناتك يومياً.",
        ...
        "zh": {
                ...
                "btn_cancel": "取消 / 关闭",
                "guide_modal_title": "FabricTag 快速入门使用指南",
                "guide_step1_title": "Google Gemini AI 密钥配置",
                "guide_step1_desc": "FabricTag 使用 Google Gemini AI 模型精准解析色卡。前往 Google AI Studio 免费获取密钥并粘贴至设置即可。",
                "guide_step1_btn": "免费获取 Google API Key",
                "guide_step2_title": "色卡快速扫描与自动识别",
                "guide_step2_desc": "支持三种扫描方式：电脑摄像头连续快拍、手机无线扫码拍照、以及直接上传相册图片。",
                "guide_step3_title": "可视化标签设计与条码打印",
                "guide_step3_desc": "上传公司 Logo，自由拖拽排序标签行，支持 A4 排版与 Argox/Zebra 热敏卷筒打印机。",
                "guide_step4_title": "Excel 批量导入导出与云备份",
                "guide_step4_desc": "一键导入已有 Excel 面料档案或导出筛选数据。OneDrive 云端自动备份每日守护数据安全。",
                "btn_understood": "了解并开始使用",
        ...
        "ja": {
                ...
                "guide_modal_title": "FabricTag クイックスタートガイド",
                "guide_step1_title": "Google Gemini AI APIキーの設定",
                "guide_step1_desc": "FabricTag は Google Gemini AI を使用してスワッチを解析します。Google AI Studio から無料キーを取得し、設定に入力してください。",
                "guide_step1_btn": "無料 Google API キーを取得",
                "guide_step2_title": "スワッチの撮影と自動OCR認識",
                "guide_step2_desc": "ウェブカメラでの連続撮影、スマホからの無線QRスキャン、または画像アップロードに対応。",
                "guide_step3_title": "ビジュアルラベルデザインとバーコード印刷",
                "guide_step3_desc": "ロゴの追加、ドラッグ＆ドロップでの行入れ替えが可能。A4用紙やロール式熱転写プリンタに完全対応。",
                "guide_step4_title": "Excel インポート/エクスポートとクラウドバックアップ",
                "guide_step4_desc": "Excelファイルの一括インポートやデータ抽出に対応。OneDrive連携で大切なデータを毎日自動保護。",
